...
(function (global, factory) {
  ...
  */
  ...
  function getBoundaries(popper, reference, padding, boundariesElement, fixedPosition) {
    if (fixedPosition === void 0) fixedPosition = false; // NOTE: 1 DOM access here
  ...
  function computeAutoPlacement(placement, refRect, popper, reference, boundariesElement, padding) {
    ...
    var filteredAreas = sortedAreas.filter(function (ref) {
      var width = ref.width;
      var height = ref.height;
  ...
  function computeStyle(data, options) {
    ...
    var y = options.y;
    var ref = data.offsets;
    var popper = ref.popper; // Remove this legacy support in Popper.js v2
  ...
  function isModifierRequired(modifiers, requestingName, requestedName) {
    ...
    if (!isRequired) {
      ...
      console.warn(requested + " modifier is required by " + requesting$1 + " modifier in order to work, be sure to include it before " + requesting$1 + "!");
    }
  ...
  function arrow(data, options) {
    var obj; // arrow depends on keepTogether in order to work
  ...
  function flip(data, options) {
    ...
    flipOrder.forEach(function (step, index) {
      ...
      if (overlapsRef || overflowsBoundaries || flippedVariation) {
        ...
        data.offsets.popper = Object.assign({}, data.offsets.popper, getPopperOffsets(data.instance.popper, data.offsets.reference, data.placement));
  ...
  var Popper = function Popper(reference, popper, options) {
    var this$1 = this;
    if (options === void 0) options = {}; // make update() debounced, so that it only runs at most once-per-tick

    this.update = debounce(this.update.bind(this));
    this.scheduleUpdate = this.scheduleUpdate.bind(this); // with {} we create a new object with the options inside it

    this.options = Object.assign({}, Popper.Defaults, options); // init state
    ...
    Object.keys(Object.assign({}, Popper.Defaults.modifiers, options.modifiers)).forEach(function (name) {
      this$1.options.modifiers[name] = Object.assign({}, Popper.Defaults.modifiers[name] || {}, // If there are custom options, override and merge with default ones
    ...
    this.modifiers.forEach(function (modifierOptions) {
      if (modifierOptions.enabled && isFunction(modifierOptions.onLoad)) {
        modifierOptions.onLoad(this$1.reference, this$1.popper, this$1.options, modifierOptions, this$1.state);
      }
