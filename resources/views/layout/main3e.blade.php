...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="shortcut icon" href="/assets/icon3e.ico" type="image/x-icon">
        ...
        <link rel="stylesheet" href="./css/menu3e.css">
        <link rel="stylesheet" href="./css/Tabelas3e.css">
        <link rel="stylesheet" href="./css/Grafico3e.css">
        <link rel="stylesheet" href="./css/app.css">
        <link rel="stylesheet" href="./css/flipnumber.css">
        <link rel="stylesheet" href="./css/Residometro3e.css">
        ...
        <header id="MenuMobile" class="MenuContainer">
            <nav>
              ...
              <li>
                ...
                <img src="./assets/logo3e.png" class="Eco3eLogo" alt="" srcset="">
                ...
                <ul class="nav-list">
                    <li><a class="btnMenu" href="3eDados">Resíduos Coletados</a></li>
                    <li><a class="btnMenu" href="3eGrafico">Grafico</a></li>
                    <li><a class="btnMenu" href="Tabelas3e">Tabelas</a></li>
                    <li><a class="btnMenu" href="Escolha">Escolha</a></li>
                </ul>
